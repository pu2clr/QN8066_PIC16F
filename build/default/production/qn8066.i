...
typedef union {
  struct {
    ...
    unsigned char ccs_ch_dis : 1;
    unsigned char chsc : 1;
    unsigned char txreq : 1;
    unsigned char rxreq : 1;
    unsigned char stnby : 1;
    unsigned char recal : 1;
...
typedef union {
  struct {
    unsigned char tc : 1;
    unsigned char rdsrdy : 1;
    unsigned char tx_mute : 1;
    unsigned char rx_mute : 1;
    unsigned char tx_mono : 1;
    unsigned char force_mo : 1;
    unsigned char tx_rdsen : 1;
    unsigned char rx_rdsen : 1;
  } arg;
  unsigned char raw;
} qn8066_system2;
# 138 "./QN8066.h"
...
typedef union {
  struct {
    ...
    unsigned char RXAGCSET : 1;
    unsigned char rxcca_fail : 1;
    unsigned char FSM : 4;
  } arg;
  unsigned char raw;
} qn8066_status1;
...
typedef union {
  struct {
    ...
    unsigned char CH_STA : 2;
    unsigned char CH_STP : 2;
    unsigned char CH_FSTEP : 2;
  } arg;
  unsigned char raw;
} qn8066_ch_step;
# 375 "./QN8066.h"
typedef union {
  struct {
    ...
    unsigned char RX_RDSD1;
    unsigned char RX_RDSD2;
    unsigned char RX_RDSD3;
    unsigned char RX_RDSD4;
    unsigned char RX_RDSD5;
    unsigned char RX_RDSD6;
    unsigned char RX_RDSD7;
  } arg;
...
typedef union {
  struct {
    ...
    unsigned char RDS2ERR : 1;
    unsigned char RDS1ERR : 1;
    unsigned char RDS0ERR : 1;
    unsigned char RDSSYNC : 1;
    unsigned char RDSC0C1 : 1;
    unsigned char E_DET : 1;
    unsigned char RDS_RXUPD : 1;
  } arg;
  unsigned char raw;
} qn8066_status2;
# 427 "./QN8066.h"
typedef union {
  struct {
    ...
    unsigned char GAIN_DIG : 3;
    unsigned char DAC_HOLD : 1;
    unsigned char TX_DIFF : 1;
  } arg;
  unsigned char raw;
} qn8066_vol_ctl;
# 446 "./QN8066.h"
typedef union {
  struct {
    ...
    unsigned char priv_mode : 1;
    unsigned char
        rds_4k_mode : 1;

    unsigned char s1k_en : 1;

    unsigned char rds_only : 1;



    unsigned char cca_int_en : 1;
...
typedef union {
  struct {
    ...
    unsigned char aud_pk : 4;
    unsigned char CAP_SH : 1;
...
typedef union {
  struct {
    ...
    unsigned char TX_RDSD1;
    unsigned char TX_RDSD2;
    unsigned char TX_RDSD3;
    unsigned char TX_RDSD4;
    unsigned char TX_RDSD5;
    unsigned char TX_RDSD6;
    unsigned char TX_RDSD7;
  } arg;
  unsigned char data[8];
} qn8066_tx_rds;
# 561 "./QN8066.h"
...
typedef union {
  struct {
    ...
    unsigned char t1m_sel : 2;
    unsigned char tx_sftclpth : 2;
  } arg;
  unsigned char raw;
} qn8066_gplt;
# 685 "./QN8066.h"
typedef union {
  struct {
    ...
    unsigned char TXAGC_GDB : 2;
    unsigned char TXAGC_GVGA : 3;
    unsigned char tx_sftclpen : 1;
  } arg;
  unsigned char raw;
} qn8066_reg_vga;
# 703 "./QN8066.h"
...
typedef union
{
    struct
    {
        unsigned int additionalData : 4;
        unsigned int textABFlag : 1;
        unsigned int programType : 5;
        unsigned int trafficProgramCode : 1;
        unsigned int versionCode : 1;
        unsigned int groupType : 4;
    } commonFields;
...
unsigned char rdsSyncTime = 60;
unsigned char rdsRepeatGroup = 5;

char rdsStationName[9] = " QN8066\r";
unsigned int rdsPI = 33179;
unsigned char rdsPTY = 5;
...
void qn8066_begin(void) {
  ...
  reg_gplt.raw = get_register(0x27);
  reg_fdev.raw = get_register(0x25);
  reg_rds.raw = get_register(0x26);
  reg_reg_vga.raw = get_register(0x28);
